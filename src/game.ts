...
script6.spawn(instagramButtonLink, {"url":"cinnamondream_art","bnw":false,"name":"Cinnamon Dream, Contemporary Art and Design"}, createChannel(channelId, instagramButtonLink, channelBus))
